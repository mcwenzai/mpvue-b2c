        ...
        >
          <view class="button-box">
            ...
            <text
              ...
              v-if="modalCuont >= modalStocks[modalStocksIndex].stockQuantity||this.typeCar==2||modalGood.newPeople"
            >
  ...
  export default {
    ...
    showModal(item, type, url) {
      ...
      item.attrs.forEach((items,index) => {
        this.chooseList[index] = items.attrValues[0].attrValueId;
        //选中的规格名称
        this.size[index] = items.attrValues[0].attrValueId;
        this.sizeName[index] = items.attrValues[0].attrValueName;
      });
